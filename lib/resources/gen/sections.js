 ...
 * This does not work for separators (tasks with the `resource_subtype` of section).
   * @param {String} section The section in which to add the task
   * @param {Object} data Data for the request
   * @param {String} data.task The task to add to this section
...
Sections.prototype.addTask = function(
  ...
  var path = util.format('/sections/%s/addTask', section);
