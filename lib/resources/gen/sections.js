 ...
 * Returns the full record of the newly created section.
   * @param {Gid} project The project to create the section in
 ...
 * Returns the compact records for all sections in the specified project.
   * @param {Gid} project The project to get sections from.
 ...
 * Returns the complete record for a single section.
   * @param {Gid} section The section to get.
   * @param {Object} [params] Parameters for the request
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
 ...
 * Returns the complete updated section record.
   * @param {Gid} section The section to update.
   * @param {Object} data Data for the request
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * Returns an empty data block.
   * @param {Gid} section The section to delete.
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * This does not work for separators (tasks with the `resource_subtype` of section).
   * @param {Gid} task The task to add to this section
   * @param {Object} data Data for the request
   * @param {Gid} [data.insert_before] Insert the given task immediately before the task specified by this parameter. Cannot be provided together with `insert_after`.
   * @param {Gid} [data.insert_after] Insert the given task immediately after the task specified by this parameter. Cannot be provided together with `insert_before`.
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 *
 * Returns an empty data block.
   * @param {Gid} project The project in which to reorder the given section
   * @param {Object} data Data for the request
   * @param {Gid} data.section The section to reorder
   * @param {Gid} [data.before_section] Insert the given section immediately before the section specified by this parameter.
   * @param {Gid} [data.after_section] Insert the given section immediately after the section specified by this parameter.
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
