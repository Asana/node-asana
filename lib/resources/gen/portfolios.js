 ...
 * their own starting state on a portfolio.
   ...
   * @param {Gid} data.workspace The workspace or organization in which to create the portfolio.
 ...
 * Returns the complete record for a single portfolio.
   * @param {Gid} portfolio The portfolio to get.
 ...
 * Returns the complete updated portfolio record.
   * @param {Gid} portfolio The portfolio to update.
   * @param {Object} data Data for the request
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * Returns an empty data record.
   * @param {Gid} portfolio The portfolio to delete.
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * by the current API user.
   * @param {Object} [params] Parameters for the request
   * @param {Gid} params.workspace The workspace or organization to filter portfolios on.
 ...
 * Get a list of the items in compact form in a portfolio.
   * @param {Gid} portfolio The portfolio from which to get the list of items.
   * @param {Object} [params] Parameters for the request
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The requested resource
 */
 ...
 * Returns an empty data block.
   * @param {Gid} portfolio The portfolio to which to add an item.
   * @param {Object} data Data for the request
   * @param {Gid} data.item The item to add to the portfolio.
   * @param {Gid} [data.insert_before] An id of an item in this portfolio. The new item will be added before the one specified here.
   * `insert_before` and `insert_after` parameters cannot both be specified.
   * @param {Gid} [data.insert_after] An id of an item in this portfolio. The new item will be added after the one specified here.
   * `insert_before` and `insert_after` parameters cannot both be specified.
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * 
 * Returns an empty data block.
   * @param {Gid} portfolio The portfolio from which to remove the item.
   * @param {Object} data Data for the request
   * @param {Gid} data.item The item to remove from the portfolio.
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * Adds the specified list of users as members of the portfolio. Returns the updated portfolio record.
   * @param {Gid} portfolio The portfolio to add members to.
   * @param {Object} data Data for the request
 ...
 * Removes the specified list of members from the portfolio. Returns the updated portfolio record.
   * @param {Gid} portfolio The portfolio to remove members from.
   * @param {Object} data Data for the request
   * @param {Array} data.members An array of user ids.
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 ...
 * Get the custom field settings on a portfolio.
   * @param {Gid} portfolio The portfolio from which to get the custom field settings.
   * @param {Object} [params] Parameters for the request
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The requested resource
 */
 ...
 * record for the new custom field setting.
   * @param {Gid} portfolio The portfolio onto which to add the custom field.
   * @param {Object} data Data for the request
   * @param {Gid} data.custom_field The id of the custom field to add to the portfolio.
   ...
   * @param {Gid} [data.insert_before] An id of a custom field setting on this portfolio. The new custom field setting will be added before this one.
   * `insert_before` and `insert_after` parameters cannot both be specified.
   * @param {Gid} [data.insert_after] An id of a custom field setting on this portfolio. The new custom field setting will be added after this one.
   * `insert_before` and `insert_after` parameters cannot both be specified.
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * block.
   * @param {Gid} portfolio The portfolio from which to remove the custom field.
   * @param {Object} data Data for the request
   * @param {Gid} data.custom_field The id of the custom field to remove from this portfolio.
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
