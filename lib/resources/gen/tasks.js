 ...
 * project the task should belong to.
   ...
   * @param {Gid} [data.workspace] The workspace to create a task in.
 ...
 * explicitly if you specify a `project` or a `parent` task instead.
   * @param {Gid} workspace The workspace to create a task in.
   * @param {Object} data Data for the request
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * Returns the complete task record for a single task.
   * @param {Gid} task The task to get.
 ...
 * Returns the complete updated task record.
   * @param {Gid} task The task to update.
   * @param {Object} data Data for the request
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * Returns an empty data record.
   * @param {Gid} task The task to delete.
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * Creates and returns a job that will asynchronously handle the duplication.
   * @param {Gid} task The task to duplicate.
   * @param {Object} data Data for the request
 ...
 * ordered by their priority within the project.
   * @param {Gid} project The project in which to search for tasks.
   * @param {Object} [params] Parameters for the request
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * Returns the compact task records for all tasks with the given tag.
   * @param {Gid} tag The tag in which to search for tasks.
   * @param {Object} [params] Parameters for the request
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * <b>Board view only:</b> Returns the compact section records for all tasks within the given section.
   * @param {Gid} section The section in which to search for tasks.
   * @param {Object} [params] Parameters for the request
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * Tasks" in Asana.)
   * @param {Gid} user_task_list The user task list in which to search for tasks.
   * @param {Object} [params] Parameters for the request
 ...
 * specify `assignee` and `workspace`.
   ...
   * @param {Gid} [params.workspace] The workspace or organization to filter tasks on.
   * @param {Gid} [params.project] The project to filter tasks on.
   * @param {Gid} [params.section] The section to filter tasks on.
   * @param {Gid} [params.tag] The tag to filter tasks on.
   * @param {Gid} [params.user_task_list] The user task list to filter tasks on.
   * @param {String} [params.completed_since] Only return tasks that are either incomplete or that have been
   * completed since this time.
 ...
 * The search endpoint allows you to build complex queries to find and fetch exactly the data you need from Asana. For a more comprehensive description of all the query parameters and limitations of this endpoint, see our [long-form documentation](/developers/documentation/getting-started/search-api) for this feature.
   * @param {Gid} workspace The workspace or organization in which to search for tasks.
   * @param {Object} [params] Parameters for the request
 ...
 * Returns the compact representations of all of the dependencies of a task.
   * @param {Gid} task The task to get dependencies on.
   * @param {Object} [params] Parameters for the request
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The requested resource
 */
 ...
 * Returns the compact representations of all of the dependents of a task.
   * @param {Gid} task The task to get dependents on.
   * @param {Object} [params] Parameters for the request
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The requested resource
 */
 ...
 * already dependencies. *A task can have at most 15 dependencies.*
   * @param {Gid} task The task to add dependencies to.
   * @param {Object} data Data for the request
 ...
 * dependents. *A task can have at most 30 dependents.*
   * @param {Gid} task The task to add dependents to.
   * @param {Object} data Data for the request
 ...
 * Unlinks a set of dependencies from this task.
   * @param {Gid} task The task to remove dependencies from.
   * @param {Object} data Data for the request
 ...
 * Unlinks a set of dependents from this task.
   * @param {Gid} task The task to remove dependents from.
   * @param {Object} data Data for the request
 ...
 * following. Returns the complete, updated record for the affected task.
   * @param {Gid} task The task to add followers to.
   * @param {Object} data Data for the request
 ...
 * following. Returns the complete, updated record for the affected task.
   * @param {Gid} task The task to remove followers from.
   * @param {Object} data Data for the request
 ...
 * Returns a compact representation of all of the projects the task is in.
   * @param {Gid} task The task to get projects on.
   * @param {Object} [params] Parameters for the request
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * Returns an empty data block.
   * @param {Gid} task The task to add to a project.
   * @param {Object} data Data for the request
   * @param {Gid} data.project The project to add the task to.
   * @param {Gid} [data.insert_after] A task in the project to insert the task after, or `null` to
   * insert at the beginning of the list.
   * @param {Gid} [data.insert_before] A task in the project to insert the task before, or `null` to
   * insert at the end of the list.
   * @param {Gid} [data.section] A section in the project to insert the task into. The task will be
 ...
 * 
 * Returns an empty data block.
   * @param {Gid} task The task to remove from a project.
   * @param {Object} data Data for the request
   * @param {Gid} data.project The project to remove the task from.
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * Returns a compact representation of all of the tags the task has.
   * @param {Gid} task The task to get tags on.
   * @param {Object} [params] Parameters for the request
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * Adds a tag to a task. Returns an empty data block.
   * @param {Gid} task The task to add a tag to.
   * @param {Object} data Data for the request
   * @param {Gid} data.tag The tag to add to the task.
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * Removes a tag from the task. Returns an empty data block.
   * @param {Gid} task The task to remove a tag from.
   * @param {Object} data Data for the request
   * @param {Gid} data.tag The tag to remove from the task.
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * Returns a compact representation of all of the subtasks of a task.
   * @param {Gid} task The task to get the subtasks of.
   * @param {Object} [params] Parameters for the request
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * for the newly created subtask.
   * @param {Gid} task The task to add a subtask to.
   * @param {Object} data Data for the request
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * Returns a compact representation of all of the stories on the task.
   * @param {Gid} task The task containing the stories to get.
   * @param {Object} [params] Parameters for the request
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
 ...
 * Returns an empty data block.
   ...
   * @param {Object} data Data for the request
   * @param {Gid} data.task Globally unique identifier for the task.
   * @param {Gid} [data.insert_before] Insert the task before the task specified by this field. The inserted
   * task will inherit the `assignee_status` of this task. `insert_before`
   * and `insert_after` parameters cannot both be specified.
   * @param {Gid} [data.insert_after] Insert the task after the task specified by this field. The inserted
   * task will inherit the `assignee_status` of this task. `insert_before`
   * and `insert_after` parameters cannot both be specified.
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
