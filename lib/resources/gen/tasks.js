 ...
 * @param {String} customId: (required) Generated custom ID for a task.
 * @param {Object} params: Parameters for the request
 * @param {Object} [dispatchOptions]: Options, if any, to pass the dispatcher for the request
 * @return {Promise} The requested resource
 */
Tasks.prototype.getTaskForCustomID = function(
    workspaceGid,
    customId,
    params,
    dispatchOptions
) {
    var path = "/workspaces/{workspace_gid}/tasks/custom_id/{custom_id}".replace("{workspace_gid}", workspaceGid).replace("{custom_id}", customId);
