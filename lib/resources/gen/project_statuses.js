 ...
 * @param {String} projectStatusPathGid: (required) The project status update to get.
 * @param {Object} data: Data for the request
 * @param {Object} [dispatchOptions]: Options, if any, to pass the dispatcher for the request
 * @return {Promise} The requested resource
 */
ProjectStatuses.prototype.deleteProjectStatus = function(
    projectStatusPathGid,
    data = {},
    dispatchOptions = {}
) {
    var path = "/project_statuses/{project_status_gid}".replace("{project_status_path_gid}", projectStatusPathGid);
