 ...
 * Returns the full record of the newly created project status update.
   * @param {Gid} project The project on which to create a status update.
 ...
 * Returns the compact project status update records for all updates on the project.
   * @param {Gid} project The project to find status updates for.
 ...
 * Returns the complete record for a single status update.
   * @param {Gid} project-status The project status update to get.
   * @param {Object} [params] Parameters for the request
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
 ...
 * Returns an empty data record.
   * @param {Gid} project-status The project status update to delete.
   * @param {Object} [dispatchOptions] Options, if any, to pass the dispatcher for the request
   * @return {Promise} The response from the API
 */
