 ...
 * @param {String} portfolioMembershipPathGid: (required)
...
PortfolioMemberships.prototype.getPortfolioMembership = function(
    portfolioMembershipPathGid,
    params = {},
    dispatchOptions = {}
) {
    var path = "/portfolio_memberships/{portfolio_membership_gid}".replace("{portfolio_membership_path_gid}", portfolioMembershipPathGid);
