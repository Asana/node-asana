 ...
 * @param {String} projectMembershipPathGid: (required)
...
ProjectMemberships.prototype.getProjectMembership = function(
    projectMembershipPathGid,
    params,
    dispatchOptions
) {
    var path = "/project_memberships/{project_membership_gid}".replace("{project_membership_path_gid}", projectMembershipPathGid);
