 ...
 * @constructor
 */
function OauthFlowBrowserPopup(options) {
  OauthFlowBrowser.call(this, options);
  this._authorizationPromise = null;
}

util.inherits(OauthFlowBrowserPopup, OauthFlowBrowser);

OauthFlowBrowserPopup.prototype.startAuthorization = function(authUrl, state) {
  var me = this;
...
OauthFlowBrowserPopup.prototype.finishAuthorization = function() {
  return this._authorizationPromise;
};

OauthFlowBrowserPopup.prototype._popupParams = function(popupWidth, popupHeight) {
...
OauthFlowBrowserPopup.runReceiver = function() {
  window.addEventListener('load', function() {
    ...
    if (window.opener) {
      ...
      opener.postMessage({ receivedUrl: currentUrl }, window.location.origin);
      window.close();
    } else {
...
module.exports = OauthFlowBrowserPopup;
