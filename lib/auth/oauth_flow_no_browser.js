...
/**
 * @returns {String} The URL Asana should "redirect" back to when authorized.
 */
OauthFlowNoBrowser.prototype.redirectUri = function() {
  return this.app.redirectUri || oauthUtil.NATIVE_REDIRECT_URI;
};
...
OauthFlowNoBrowser.prototype.authorizeUrl = function() {
  return url.resolve(this.app.asanaBaseUrl, url.format({
...
OauthFlowNoBrowser.prototype.tokenUrl = function() {
  return url.resolve(this.app.asanaBaseUrl, '/-/oauth_token');
};
