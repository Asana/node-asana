...
export class ExportsApi {
    ...
    */
     ...
     * @param body A JSON payload specifying the parent object to export.
     * @returns A Promise, with an object containing data and HTTP response
     */
    createGraphExportWithHttpInfo(body: any): Promise<{ response: any; data: any }>;
     ...
     * @returns A Promise
     */
    createGraphExport(body: any): Promise<any>;
     ...
     * @param body A JSON payload specifying the resources to export, including filters to apply and fields to be exported.
     * @returns A Promise, with an object containing data and HTTP response
     */
    createResourceExportWithHttpInfo(body: any): Promise<{ response: any; data: any }>;
     ...
     * @returns A Promise
     */
    createResourceExport(body: any): Promise<any>;
