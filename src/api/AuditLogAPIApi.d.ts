...
export class AuditLogAPIApi {
    ...
    */
     ...
     * @param opts.start_at Filter to events created after this time (inclusive).
     * @param opts.end_at Filter to events created before this time (exclusive).
     * @param opts.event_type Filter to events of this type. Refer to the [supported audit log events](/docs/audit-log-events#supported-audit-log-events) for a full list of values.
     * @param opts.actor_type Filter to events with an actor of this type. This only needs to be included if querying for actor types without an ID. If &#x60;actor_gid&#x60; is included, this should be excluded.
     * @param opts.actor_gid Filter to events triggered by the actor with this ID.
     * @param opts.resource_gid Filter to events with this resource ID.
     ...
     */
    getAuditLogEventsWithHttpInfo(workspace_gid: string, opts?: { 'start_at'?: any; 'end_at'?: any; 'event_type'?: string; 'actor_type'?: string; 'actor_gid'?: string; 'resource_gid'?: string; 'limit'?: any; 'offset'?: string;  }): Promise<Collection | { response: any; data: any }>;
     ...
     * @returns A Promise
     */
    getAuditLogEvents(workspace_gid: string, opts?: { 'start_at'?: any; 'end_at'?: any; 'event_type'?: string; 'actor_type'?: string; 'actor_gid'?: string; 'resource_gid'?: string; 'limit'?: any; 'offset'?: string;  }): Promise<Collection | any>;
