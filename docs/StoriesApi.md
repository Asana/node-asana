...
------------- | ------------- | -------------
[**createStoryForGoal**](StoriesApi.md#createStoryForGoal) | **POST** /goals/{goal_gid}/stories | Create a story on a goal
...
[**getStoriesForGoal**](StoriesApi.md#getStoriesForGoal) | **GET** /goals/{goal_gid}/stories | Get stories from a goal
...
([more information](https://developers.asana.com/reference/createstoryforgoal))
...
([more information](https://developers.asana.com/reference/getstoriesforgoal))
