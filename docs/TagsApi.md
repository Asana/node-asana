...
let body = new Asana.TagsBody.constructFromObject({data: {param1: "value1", param2: "value2",}}); // TagsBody | The tag to create.
let opts = { 
...
> TagResponseData createTagForWorkspace(bodyworkspace_gid, opts)
...
let apiInstance = new Asana.TagsApi();
let body = new Asana.WorkspaceGidTagsBody.constructFromObject({data: {param1: "value1", param2: "value2",}}); // WorkspaceGidTagsBody | The tag to create.
...
<a name="deleteTag"></a>
# **deleteTag**
> EmptyResponseData deleteTag(tag_gid)
