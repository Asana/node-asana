...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MembershipCompactGoal', function() {
      beforeEach(function() {
        instance = new Asana.MembershipCompactGoal();
      });

      it('should create an instance of MembershipCompactGoal', function() {
        // TODO: update the code to test MembershipCompactGoal
        expect(instance).to.be.a(Asana.MembershipCompactGoal);
      });
