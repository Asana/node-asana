...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GoalMembershipResponseUser', function() {
      beforeEach(function() {
        instance = new Asana.GoalMembershipResponseUser();
      });

      it('should create an instance of GoalMembershipResponseUser', function() {
        // TODO: update the code to test GoalMembershipResponseUser
        expect(instance).to.be.a(Asana.GoalMembershipResponseUser);
      });
