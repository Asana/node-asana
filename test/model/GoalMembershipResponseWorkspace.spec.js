...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GoalMembershipResponseWorkspace', function() {
      beforeEach(function() {
        instance = new Asana.GoalMembershipResponseWorkspace();
      });

      it('should create an instance of GoalMembershipResponseWorkspace', function() {
        // TODO: update the code to test GoalMembershipResponseWorkspace
        expect(instance).to.be.a(Asana.GoalMembershipResponseWorkspace);
      });
