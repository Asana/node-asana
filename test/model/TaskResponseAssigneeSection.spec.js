...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TaskResponseAssigneeSection', function() {
      beforeEach(function() {
        instance = new Asana.TaskResponseAssigneeSection();
      });

      it('should create an instance of TaskResponseAssigneeSection', function() {
        // TODO: update the code to test TaskResponseAssigneeSection
        expect(instance).to.be.a(Asana.TaskResponseAssigneeSection);
      });
