...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProjectResponseWorkspace', function() {
      beforeEach(function() {
        instance = new Asana.ProjectResponseWorkspace();
      });

      it('should create an instance of ProjectResponseWorkspace', function() {
        // TODO: update the code to test ProjectResponseWorkspace
        expect(instance).to.be.a(Asana.ProjectResponseWorkspace);
      });
