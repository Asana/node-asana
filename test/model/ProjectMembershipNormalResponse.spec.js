...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProjectMembershipNormalResponse', function() {
      beforeEach(function() {
        instance = new Asana.ProjectMembershipNormalResponse();
      });

      it('should create an instance of ProjectMembershipNormalResponse', function() {
        // TODO: update the code to test ProjectMembershipNormalResponse
        expect(instance).to.be.a(Asana.ProjectMembershipNormalResponse);
      });
