...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MembershipCompactMember', function() {
      beforeEach(function() {
        instance = new Asana.MembershipCompactMember();
      });

      it('should create an instance of MembershipCompactMember', function() {
        // TODO: update the code to test MembershipCompactMember
        expect(instance).to.be.a(Asana.MembershipCompactMember);
      });
