...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProjectMembershipCompactResponse', function() {
      beforeEach(function() {
        instance = new Asana.ProjectMembershipCompactResponse();
      });

      it('should create an instance of ProjectMembershipCompactResponse', function() {
        // TODO: update the code to test ProjectMembershipCompactResponse
        expect(instance).to.be.a(Asana.ProjectMembershipCompactResponse);
      });
