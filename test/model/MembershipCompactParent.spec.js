...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MembershipCompactParent', function() {
      beforeEach(function() {
        instance = new Asana.MembershipCompactParent();
      });

      it('should create an instance of MembershipCompactParent', function() {
        // TODO: update the code to test MembershipCompactParent
        expect(instance).to.be.a(Asana.MembershipCompactParent);
      });
