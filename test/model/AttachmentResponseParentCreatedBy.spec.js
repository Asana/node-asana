...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AttachmentResponseParentCreatedBy', function() {
      beforeEach(function() {
        instance = new Asana.AttachmentResponseParentCreatedBy();
      });

      it('should create an instance of AttachmentResponseParentCreatedBy', function() {
        // TODO: update the code to test AttachmentResponseParentCreatedBy
        expect(instance).to.be.a(Asana.AttachmentResponseParentCreatedBy);
      });
